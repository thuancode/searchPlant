...
class LikeArticlesAdapterProfile (private val listArticles:ArrayList<Articles>)
    :RecyclerView.Adapter<LikeArticlesAdapterProfile.ViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): LikeArticlesAdapterProfile.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.species_profile_item,parent,false)
        return LikeArticlesAdapterProfile.ViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: LikeArticlesAdapterProfile.ViewHolder, position: Int) {
